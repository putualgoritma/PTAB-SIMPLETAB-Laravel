...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.absence.storeImport") }}" method="POST" enctype="multipart/form-data">
            @csrf
...
<label for="example">Download Contoh :</label>
              <a href="{{asset('files/ImportAbsenceReguler.xlsx')}}" download class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Download Berkas </a>
