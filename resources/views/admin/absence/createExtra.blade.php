...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.absence.storeExtra") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('time') ? 'has-error' : '' }}">
                <label for="time">Jam Lembur*</label>
            ...
            <div class="form-group {{ $errors->has('time_end') ? 'has-error' : '' }}">
                <label for="time_end">Selesai Lembur *</label>
