...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.absence.storeImportShift") }}" method="POST" enctype="multipart/form-data">
            @csrf
...
<label for="example">Download Contoh :</label>
              <a href="{{asset('files/ImportAbsenceShift.xlsx')}}" download class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Download Berkas </a>
