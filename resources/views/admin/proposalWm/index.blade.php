...
<script>
  ...
  let dtOverrideGlobals = {
    ...
    columns: [
        ...
        { data: 'status_wm', name: 'status_wm' },
        { data: 'priority', name: 'priority' },
        { data: 'periode', name: 'periode' },
        { data: 'created_at', name: 'created_at' },
        { data: 'updated_at', name: 'updated_at' },
        // { data: 'status', name: 'status' },
        { data: 'status', render: function (dataField) { return dataField === 'pending' ?'<button type="button" class="btn btn-warning btn-sm" disabled>' +dataField+ '</button>' : dataField === 'active' ?
        '<button type="button" class="btn btn-success btn-sm" disabled> active </button>': dataField === 'close' ?'<button type="button" class="btn btn-primary btn-sm" disabled> close </button>': '<button type="button" class="btn btn-secondary btn-sm" disabled>' +dataField+ '</button>'; } },
