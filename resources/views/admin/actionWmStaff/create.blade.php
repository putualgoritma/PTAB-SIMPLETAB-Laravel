                        ...
                        <tr data-entry-id="{{ $staff->id }}">
                            ...
                            <td>
                                @can('action_staff_create')
                                    <form action="{{ route('admin.actionWmStaff.store', [$action_id]) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
                                        @csrf
                                        @method('POST')
                                        <input type="hidden" value="{{$action_id}}" name="action_id" >
                                        <input type="hidden" value="{{$proposal_wm_id}}" name="proposal_wm_id" >
