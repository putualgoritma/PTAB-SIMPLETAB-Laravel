...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.suratsegel.suratPdf") }}" method="POST" enctype="multipart/form-data">
            @csrf
...
<input type="hidden" value="{{ $id }}" name='id'>
            ...
            <div class="form-group {{ $errors->has('jenisSurat') ? 'has-error' : '' }}">
                ...
                <select id="jenisSurat" name="jenis" class="form-control" value="{{ old('jenisSurat', isset($user) ? $user->jenisSurat : '') }}">
