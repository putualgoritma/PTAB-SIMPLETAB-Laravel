...
@can('lock_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.lockT.lockcreate', $lockaction_id) }}">
                        ...
                        <tr data-entry-id="{{ $action->id }}">
                            ...
                            <td>
                                @can('action_staff_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.lockT.LockView', [$action->id]) }}">
                                       View
                                    </a>
                                @endcan
                                @can('action_delete')
                                    <form action="{{ route('admin.lockT.actiondestroy', $action->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
