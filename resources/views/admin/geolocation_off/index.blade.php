...
@section('content')
{{-- @can('geolocation_off_create') --}}
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-3">
            <a class="btn btn-success" href="{{ route('admin.geolocation_off.create',['type'=>'geolocation_off']) }}">
                {{ trans('global.add') }} {{ trans('global.geolocation_off.title_singular') }}
            </a>
        </div>
    </div>
...
<div class="card">
    ...
    <div class="card-header">
        {{ trans('global.geolocation_off.title_singular') }} {{ trans('global.list') }}
    </div>
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable ajaxTable datatable-geolocation_off">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        {{-- <th>
                            {{ trans('global.geolocation_off.fields.id') }}
                        </th> --}}
                        <th>
                        ...
                        <th>
                            {{ trans('global.geolocation_off.fields.created_at') }}
                        </th>
                   
                        {{-- <th>
                            {{ trans('global.geolocation_off.fields.upstartd_at') }}
                        </th> --}}
                        <th>
                            &nbsp;
                        </th>
...
<script>
  ...
  let dtOverrideGlobals = {
    ...
    aaSorting: [],
    ajax: {
      url: "{{ route('admin.geolocation_off.index') }}",
      data: {
        'status': $("#status").val(),
        'from': $("#from").val(),
        'to': $("#to").val(),
  ...
  $('.datatable-geolocation_off').DataTable(dtOverrideGlobals);
