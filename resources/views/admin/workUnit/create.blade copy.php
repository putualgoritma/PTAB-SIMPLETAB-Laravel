    ...
    <div class="card-body">
        <form action="{{ route("admin.workUnit.store") }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group {{ $errors->has('lat') ? 'has-error' : '' }}">
            ...
            <input type="text" id="lat" name="lat" class="form-control" value="{{ old('lat', isset($workUnit) ? $workUnit->lat : '') }}" readonly required>
            @if($errors->has('lat'))
                <em class="invalid-feedback">
                    {{ $errors->first('lat') }}
                </em>
        ...
        <div class="form-group {{ $errors->has('lng') ? 'has-error' : '' }}">
            ...
            <input type="text" id="lng" name="lng" class="form-control" value="{{ old('lng', isset($workUnit) ? $workUnit->lng : '') }}" readonly required>
            @if($errors->has('lng'))
                <em class="invalid-feedback">
                    {{ $errors->first('lng') }}
                </em>
