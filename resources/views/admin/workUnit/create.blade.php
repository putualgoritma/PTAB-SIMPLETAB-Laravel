...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group {{ $errors->has('radius') ? 'has-error' : '' }}">
            ...
            <input type="number" id="radius" min = "1" value="10" name="radius" class="form-control" value="{{ old('radius', isset($workUnit) ? $workUnit->radius : '') }}" required>
