...
@can('lock_staff_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.lockT.actionStaffCreate', $action->id) }}">
                        ...
                        <tr data-entry-id="{{ $staff->id }}">
                            ...
                            <td>
                                @can('lock_staff_delete')
                                    <form action="{{ route('admin.lockT.actionStaffDestroy', [$action->id, $staff->id]) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
