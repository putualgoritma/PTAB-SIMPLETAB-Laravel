                        ...
                        foreach ($c as $item) {
                            ...
                            try {
                                for ($n = 0; $n < count($list_absence); $n++) {
                                    $expired_date = date("Y-m-d H:i:s", strtotime('+ ' . ($list_absence[0]->duration + $list_absence[0]->duration_exp) . ' hours', strtotime(date('Y-m-d ' . $list_absence[0]->time))));
                                    $timeout = date("Y-m-d H:i:s", strtotime('+ ' . $list_absence[0]->duration . ' hours', strtotime(date('Y-m-d ' . $list_absence[0]->time))));
                                    ...
                                    if ($list_absence[$n]->queue == "1") {
                                        $start_date = date("Y-m-d H:i:s", strtotime('- ' . $list_absence[0]->duration_exp . ' hours', strtotime(date('Y-m-d ' . $list_absence[0]->time))));
                                    } else {
                                        $start_date = date("Y-m-d H:i:s", strtotime('+ ' . ($list_absence[0]->duration - $list_absence[0]->duration_exp) . ' hours', strtotime(date('Y-m-d ' . $list_absence[0]->time))));
                                    }
