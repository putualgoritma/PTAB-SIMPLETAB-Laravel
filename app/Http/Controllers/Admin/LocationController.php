...
class LocationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!in_array('absence_all_access', $checker)) {
            $qry = AbsenceRequest::selectRaw('absence_requests.*, staffs.name as staff_name')
                ...
                ->where('absence_requests.category', 'location')
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.location.create', compact('staffs', 'type'));
    }

    public function show($id)
    {
        // abort_unless(\Gate::allows('location_access'), 403);
        $location = AbsenceRequest::selectRaw('absence_requests.*, staffs.name as staff_name')
            ->join('staffs', 'staffs.id', '=', 'absence_requests.staff_id')
        ...
        // dd($location, $file);
        return view('admin.location.show', compact('location', 'file'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $location = AbsenceRequest::create($data);
    ...
    public function edit($id)
    {
        ...
        return view('admin.location.edit', compact('users', 'type', 'requests'));
    }
    public function update(Request $request, $id)
    {
        // abort_unless(\Gate::allows('location_edit'), 403);
        $location = Requests::where('id', $id)
